  ...
  <x-slot:title>Edit Transaction</x-slot:title>
    ...
    <div class="flex flex-col md:flex-row w-full md:justify-between md:items-end">
        <div>
            ...
            <h1 class="text-4xl font-bold mb-2">Edit Transaction</h1>
        </div>
    </div>
            ...
            <div class="card bg-base-100 shadow-xl border border-base-300">
                <div class="card-body">
                    <div class="flex items-center gap-3 mb-6">
                        ...
                        <h2 class="card-title text-xl">Edit Transaction</h2>
                    </div>
                    ...
                    <div class="alert alert-warning mb-6">
                        ...
                        <span>Editing this transaction will recalculate stock levels. Make sure the changes are correct.</span>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative">
                                <select name="type"
                                        ...
                                        required>
                                    <option value="in" {{ old('type', $transaction->type) == 'in' ? 'selected' : '' }}>Stock In</option>
                                    <option value="out" {{ old('type', $transaction->type) == 'out' ? 'selected' : '' }}>Stock Out</option>
                                </select>
                                <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-base-content/40 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                        ...
                        <div class="form-control">
                            ...
                            <div class="relative">
                                <input type="number"
                                       ...
                                       class="input input-bordered w-full pr-10 @error('quantity') input-error @enderror"
                                       placeholder="0"
                                       min="1"
                                       required />
                                <svg class="absolute right-3 top-1/2 -translate-y-1/2 w-5 h-5 text-base-content/40 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="form-control md:col-span-2">
                            ...
                            <div class="relative">
                                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-base-content/70 font-medium z-10 pointer-events-none">₱</span>
                                <input type="number"
                                       name="cost_price"
                                       value="{{ old('cost_price', $transaction->cost_price) }}"
