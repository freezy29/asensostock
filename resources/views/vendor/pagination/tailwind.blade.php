                ...
                <span class="join rtl:flex-row-reverse">
                    ...
                    @if ($paginator->onFirstPage())
                        <span aria-disabled="true" aria-label="{{ __('pagination.previous') }}">
                            <span class="btn btn-sm join-item btn-disabled" aria-hidden="true">
                    ...
                    @foreach ($elements as $element)
                        ...
                        @if (is_string($element))
                            <span aria-disabled="true">
                                <span class="btn btn-sm join-item btn-disabled">{{ $element }}</span>
                            </span>
                        @endif
                            ...
                            @foreach ($element as $page => $url)
                                @if ($page == $paginator->currentPage())
                                    <span aria-current="page">
                                        <span class="btn btn-sm join-item btn-active">{{ $page }}</span>
                                    </span>
                                @else
