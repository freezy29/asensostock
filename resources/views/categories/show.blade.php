        ...
        <div class="card bg-base-100 shadow-xl border border-base-300">
            <div class="card-body">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="space-y-4">
                        <div>
                            <div class="text-sm text-base-content/70 mb-1">Category ID</div>
                            <div class="font-medium">{{ $category->id }}</div>
                        </div>

                        <div>
                            <div class="text-sm text-base-content/70 mb-1">Category Name</div>
                            <div class="font-medium text-lg">{{ $category->name }}</div>
                        </div>

                        <div>
                            <div class="text-sm text-base-content/70 mb-1">Number of Products</div>
                            <div class="font-medium text-lg">{{ $category->products_count }}</div>
                        </div>
                    </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            ...
                            <div class="font-medium">{{ $category->updated_at->format('M d, Y') }}</div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-6 pt-6 border-t border-base-300">
                    <div class="flex items-center justify-between mb-4">
                        <h3 class="font-semibold text-base">Products in this Category</h3>
                        <a href="{{ route('products.index') }}?category={{ $category->id }}" class="btn btn-sm btn-ghost">
                            View All
                        </a>
                    </div>
                ...
                <div class="mt-6 pt-6 border-t border-base-300">
                    <div class="text-center py-8">
                        <p class="text-base-content/70">No products in this category yet.</p>
